...
class myItemViewCell :UICollectionViewCell, NTTansitionWaterfallGridViewProtocol{
    ...
    override func layoutSubviews() {
        ...
        */
        ...
        imageLabel2.textColor = UIColor(red: 67/255.0, green: 178/225.0, blue: 229/255.0, alpha: 1)
