...
//  Swapit
//
//  Created by Dustin Yang on 9/12/15.
...
class JTSplashView: UIView {
   ...
   var bgColor = UIColor(red: 0.0 / 255.0, green: 0.0 / 255.0, blue: 0.0 / 255.0, alpha: 1.0)
   // var bgColor = UIColor.
  //  var circleColor = UIColor(red: 110.0 / 255.0, green: 180.0 / 255.0, blue: 240.0 / 255.0, alpha: 1.0)
    var circleColor = UIColor(red: 0.0 / 255.0, green: 0.0 / 255.0, blue: 0.0 / 255.0, alpha: 1.0)
  ...
  //  var image = UIImageView(image: UIImage(named: "bar.gif"))
    var image = UIImageView(frame: CGRectMake(0, 0, screenSize.width, screenSize.height))
